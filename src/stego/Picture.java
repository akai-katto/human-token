 ...
 * The original image can be stego.StegoRead from a {@code PNG}, {@code GIF},
...
public final class Picture implements ActionListener {
     ...
     * @throws IllegalArgumentException if cannot stego.StegoRead image
    ...
    public Picture(String filename) {
        ...
        try {
            // try to stego.StegoRead from file in working directory
            File file = new File(filename);
            if (file.isFile()) {
                image = ImageIO.read(file);
            }

            // now try to stego.StegoRead from file in same directory as this .class file
            else {
            ...
            if (image == null) {
                throw new IllegalArgumentException("could not stego.StegoRead image file: " + filename);
            }
    ...
    public Picture(File file) {
        ...
        if (image == null) {
            throw new IllegalArgumentException("could not stego.StegoRead file: " + file);
        }
        width = image.getWidth(null);
        height = image.getHeight(null);
    ...
    /**
     * Unit tests this {@code stego.Picture} data type.
